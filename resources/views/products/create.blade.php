                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4" class="mt-1 block w-full">{{ old('description') }}</textarea>
                            </div>
                            <div>
                                <label for="price" class="block text-sm font-medium">Preço</label>
                                <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01" class="mt-1 block w-full" required>
                            </div>
                        </div>
